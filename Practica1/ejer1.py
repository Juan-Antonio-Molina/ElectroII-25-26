...
- Deemuestre numéricamente que el campo cumple la ley de Coulomb, i.e., E = K 1/r^2
...
# Etiquetas y leyenda
ax_ajuste.set_xlabel('1/distancia^2')
ax_ajuste.set_ylabel('Componente E')
ax_ajuste.set_title('Ajuste Lineal del Campo Eléctrico')
ax_ajuste.legend()
...
# Dibujar los puntos y el ajuste en un nuevo subplot
fig_ajuste, ax_ajuste = plt.subplots(figsize=(8, 6))
ax_ajuste.scatter(inv_dist, E2x, label='Puntos de datos')
ax_ajuste.plot(inv_dist, E2x, color='red', label='funcion')

# Etiquetas y leyenda
ax_ajuste.set_xlabel('1/distancia')
ax_ajuste.set_ylabel('Componente E')
ax_ajuste.set_title('Ajuste Lineal del Campo Eléctrico')
ax_ajuste.legend()
