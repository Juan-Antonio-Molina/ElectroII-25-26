...
print(f"La máxima desviación encontrada para K perpendicular es {err_kperp}, siendo la inicial Rg = {k_perp[0]}")
print(f"La máxima desviación encontrada para K paralela es {err_kpara}, siendo la inicial Rg = {k_para[0]}")
print(f"La máxima desviación encontrada para u es {err_u}, siendo la inicial Rg = {u_1[0]}")
